...
public sealed class PromotePackageInput
{
    ...
    // Group/namespace of the package to repackage (e.g. "types")
    public string? Group { get; init; }

    // Name of the package to promote (e.g. "react")
    public required string Name { get; init; }

    // Version of the package to promote (e.g. "18.2.0")
    public required string Version { get; init; }

    // Target feed to which the package will be promoted (e.g. "approved-npm")
    public required string ToFeed { get; init; }

    // Comments regarding the promotion operation (e.g. "Approved for production use")
