...
// JSON Object used by the List Feed Storage Types HTTP endpoint
public sealed class FeedStorageType
{
    // ID of the feed storage type (e.g. "disk", "s3", or "azure")
    ...
    // Properties specific to the feed storage properties
    // * See FeedStorageTypePropertyInfo.cs for more details
